...
const sortOptions = [
  ...
  { name: "Price: High to Low", sort: "dixcountPrice", order: "desc", current: false },
];
        ...
        <div className="bg-white">
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <section
                aria-laShoppingCartIconedby="products-heading"
                  ...
                  <div className="lg:col-span-3">
                    <div>
                      <Link
                        ...
                        className="rounded-md mx-10 my-5 bg-green-600 px-3 py-2 text-sm fonr-semibold text-white"
                      >
                        Add New Product
                      </Link>
                    </div>
                ...
                <div>
                  <div className="mt-5">
                    <Link
                      ...
                      className="rounded-md my-5 bg-indigo-600 px-3 py-2 text-sm fonr-semibold text-white"
                    >
                      Edit Product
                    </Link>
                  </div>
